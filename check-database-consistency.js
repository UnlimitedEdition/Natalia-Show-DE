...
// Koristimo istu konfiguraciju kao u ostatku aplikacije
const SUPABASE_URL = "https://ykixjxocfbcczvkjgwts.supabase.co";
const SUPABASE_SERVICE_ROLE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.VITE_SUPABASE_SERVICE_ROLE_KEY

// Ako nemamo service role key, pokušavamo sa publishable key (manje privilegije)
const SUPABASE_KEY = SUPABASE_SERVICE_ROLE_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlraXhqeG9jZmJjY3p2a2pnd3RzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTcxNjA4MjYsImV4cCI6MjA3MjczNjgyNn0.oI57oJXfm7QEwfIbred6XeRiEcRJ1Xu9rO42Ta8hTSU";
...
if (process.argv[1] && process.argv[1].endsWith('check-database-consistency.js')) {
